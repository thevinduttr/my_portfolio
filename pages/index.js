  ...
  return <div className="bg-primary h-full">
    ...
    <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
      <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
        ...
        Hello and Welcome! <br /> I'm{' '} <span className="text-accent"> Thevindu</span>
        </motion.h1>
    ...
    <div className="w-[1100px] h-full absolute right-0 bottom-0">
      ...
      {/* avater img*/}
      <motion.div variants={fadeIn('up' , 0.5)} initial="hidden" animate="show" exit="hidden" transition={{duration: 1 , ease: 'easeInOut'}} className="w-full h-full max-w-[637px] max-h-[578px] absolute -bottom-32 lg:bottom-0 lg:right-[1%]">
        <Avatar />
      </motion.div>
    </div>
  </div>;
