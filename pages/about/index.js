...
const aboutData = [
  {
    ...
    info: [
      ...
      },
      {
        ...
        icons: [<FaJava />, <FaPython />, <SiC /> , <SiCplusplus />],
      },
      {
        title: 'Mobile App Development',
        icons: [<SiKotlin />, <SiAndroidstudio />],
      },
      {
        title: 'SQL & Database Management',
        icons: [<SiMysql />, <SiMongodb />, <SiSqlite />],
      },
      {
        title: 'UI/UX Design',
...
const About = () => {
  ...
  return <div className="h-full bg-primary py-32 text-center xl:text-left">
    <Circles />

    {/* avatar img */}
    <motion.div variants={fadeIn('right', 0.2)} initial="hidden" animate="show" exit={'hidden'} className="hidden xl:flex absolute -bottom-1/4 -left-[235px]">
      <Avatar />
    </motion.div>
    ...
    <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
      ...
      <div className="flex-1 flex flex-col justify-center mt-5">
        <motion.h2 variants={fadeIn('right', 0.2)} initial="hidden" animate="show" exit={'hidden'} className="h2">Crafting  <span className="text-accent">stories</span> through code and innovation.</motion.h2>
        <motion.p variants={fadeIn('right', 0.4)} initial="hidden" animate="show" exit={'hidden'} className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-10 px-2 xl:px-0">I'm Thevindu Thulnith Rathnaweera, a 3rd-year student at SLIIT. Passionate about coding and software development, I excel in leadership and quality assurance. At 21+, I'm eager to innovate and collaborate. Let's build something great together!</motion.p>
